...
//GANTI SEMUA DI SINI
namaowner = 'RIYAN BOTZ' 
namabot = 'Boy Bot' 
nomorbot = '6285809326016'//GANTI NOMOR BOT LOE
nomerowner = '6283153406515'//‼️❗‼️ GANTI SESUAI CONTOH!!
nomerowner2 = '+62 831-5340-6515' //‼️❗‼️ GANTI SESUAI CONTOH!!
prefix = '.'
limitawal = "10"
gamewaktu = '30'
hargalimit = '500'
...
fake = 'LAH, DI HAPUS'
fake1 = '*BoyBot*'
fake2 = '*YouTube : RIYAN BOTZ*'
lolkey = ' BELI YA BANG :)'
zekskey = 'apivinz'
imgbg = 'https://i.ibb.co/tx5Dbhr/images.jpg'
sosmedowner = 'FOLLOW FB OWNER : Ariyan Ferdiansyah'
teksban = 'Maaf kamu sudah terbenned!'
tagown = 'JANGAN DI TAG DIA LAGI SIBUK :V'
	...
	try {
		...
		if (urutan_pesan === 5000) {
			...
			const groupAdmins = isGroup ? getGroupAdmins(groupMembers) : ''
               	const ftoko = { key: { fromMe: false, participant: `6281241405996@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./database/image/Farid.jpeg') }, "title": `Subrek : ItsMeMuzza`, "productImageCount": 9999 }, "businessOwnerJid": `6281241405996@s.whatsapp.net`}}}
	            const muz1 = {
                  key: {
			fromMe: false, 
			participant: `6282189387018@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})
	        	},
     		      message: {
			"productMessage": {
				"product": {
			    	...
			    	"businessOwnerJid": `6282189387018@s.whatsapp.net`
	     	      }
            	}
            }
            mess = {
...
addKoinUser('6281241405996@s.whatsapp.net', fee)
...
farid.sendMessage(from, wew, image, {thumbnail:fs.readFileSync('./database/image/gambar.jpeg'), quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: 'status@broadcast' } : {}) }, message: { 'productMessage': { 'product': { 'productImage':{ 'mimetype': 'image/jpeg', 'jpegThumbnail': fs.readFileSync('./database/image/Farid.jpeg') }, 'title': `⊳ Made With ❣️ By Muzza ⊲`, 'productImageCount': 9999 }, 'businessOwnerJid': `0@s.whatsapp.net`}}}, caption: muz})
break
case 'menucek':
case 'cekmenu':
if (!isRegister) return reply( ind.noregis())
